const KorzhData = {
    ...
    journal: [
    { date: "17.01", text: "ЗАПИСЬ 01: Инициация. Мне 30 лет. Телефон, наряд, холод. Пока все спят, я вспоминаю базу HTML. Зачем? Чтобы постучать в твою дверь чем-то уникальным. Обычные слова — это слишком просто для Коржика." },
    { date: "17.01", text: "ЗАПИСЬ 02: Режим выживания. Код пишется тяжело, пальцы мерзнут. Но каждая закрытая скобка — это мой личный манифест против хаоса вокруг. Это мой мост домой." },
    { date: "18.01", text: "ЗАПИСЬ 03: Архитектура. Собрал скелет. Ты — сложный программный код с кучей условий. Чтобы войти в твой мир, нужен не просто пароль, а понимание." },
    { date: "19.01", text: "ЗАПИСЬ 04: Первый контакт. Скинул ссылку. Ты спросила: 'Для чего это?'. Я ответил — практика. Но каждый пиксель здесь — попытка перевести твой вайб в цифру." },
    { date: "19.01", text: "ЗАПИСЬ 05: Улыбка. Ты написала: 'Круто выходит'. Система ожила. Первый барьер пройден. Мой главный KPI на сегодня выполнен." },
    { date: "20.01", text: "ЗАПИСЬ 06: Анализ. Пять планет в Рыбах. Ты — целый океан чувств. Моя задача как разработчика — построить для этого океана надежные берега из логики." },
    { date: "20.01", text: "ЗАПИСЬ 07: Техподдержка. Исправил баг с ВК. В жизни баги фиксить сложнее, но в коде я — бог. Твой смех в ответ — лучшая награда." },
    { date: "21.01", text: "ЗАПИСЬ 08: Вектор. Ты болеешь. Хочется быть рядом, в кресле напротив, а не за экраном. Этот сайт — моя виртуальная забота, пока я в расположении." },
    { date: "21.01", text: "ЗАПИСЬ 09: Исследование. Узнал про 'Пилот'. 'Нет иного рая'. Твои звезды светят не всем. Теперь я знаю их секрет и зашифровал его в неон." },
    { date: "21.01", text: "ЗАПИСЬ 10: Трепет. Боюсь сфальшивить в ГС. Но ты говоришь: 'ГС супер'. Значит, мой голос проходит сквозь все глушилки и помехи." },
    { date: "22.01", text: "ЗАПИСЬ 11: Культурный код. Мой Бродский против твоего Есенина. Лёд и пламя. Код становится таким же глубоким, как наш диалог." },
    { date: "22.01", text: "ЗАПИСЬ 12: Режим Медведя. Чай, мёд, тишина. Пытаюсь представить, как ты поправляешь волосы. Это самое дорогое изображение, которое не подгрузить через URL." },
    { date: "23.01", text: "ЗАПИСЬ 13: Точка боли. Написал слишком личное. Рука дрогнула. Удалил. Поставил 'DELETED'. Боюсь своим грубым миром задеть твой покой." },
    { date: "23.01", text: "ЗАПИСЬ 14: Идентификация. Мой позывной — 'Немой'. Обет молчания о самом важном. Если ты читаешь это — значит, ты вскрыла мой архив." },
    { date: "24.01", text: "ЗАПИСЬ 15: Указ №1. Спасение животных. В этом мире, где всё рушится, твоя доброта — единственный стабильный сервер. Поддерживаю всеми ресурсами." },
    { date: "24.01", text: "ЗАПИСЬ 16: Декаданс. Бодлер. 'Цветы зла'. Тьма манит нас обоих. Внедрил багровый неон. Ты прекрасна в любом цвете, даже в самом мрачном." },
    { date: "24.01", text: "ЗАПИСЬ 17: Трансформация. 3 секунды на смену реальности. Медленное погружение в бездну. Ради твоего одного 'Ахаха' я готов переписать этот мир с нуля." },
    { date: "25.01", text: "ЗАПИСЬ 18: Материализация. Роза, браслет, букет. Код превращается в материю. 28-й виток скоро. Таймер запущен. Время тает." },
    { date: "26.01", text: "ЗАПИСЬ 19: Наблюдение. Сказали, тебе 'ничего не нужно от мужиков-козлов'. Пусть говорят. Я даже этот статус еще не заслужил, я — другой алгоритм." },
    { 
        date: "27.01.2026 / 03:00", 
        text: "ЗАПИСЬ 20: МАГНУМ ОПУС. Завтра — тёмный день. Мало кто знает степень опасности. Я смеюсь, но внутри одно желание: просто посидеть с тобой в кресле напротив. Увидеть твою искреннюю улыбку глазами, а не смайликом. Если меня не станет — знай: я буду ломать хребты всем чертям на твоем пути и с того света. Свети, Коржик. А я включу музыку..."
    }
]
